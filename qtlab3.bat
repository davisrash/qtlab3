...
SET PYTHON_PATH=C:\Users\physics-svc-laroche\.conda\envs\qtlab3
...
IF EXIST "%PYTHON_PATH%\scripts\ipython3.exe" (
    start Console -w "QTLab" -r "/k %PYTHON_PATH%\python.exe %PYTHON_PATH%\scripts\ipython3.exe --gui=gtk -i source/qtlab_shell.py -- %*"
    GOTO EOF
)
