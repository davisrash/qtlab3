        ...
        for x1 in x_vector1:
            ...
            for x2 in x_vector2:
                ...
                if( datavalues[3] > threshold):  # threshold on what the gate leakage is reading
                    ...
                    data_fwd.add_data_point(x1,x2,0,datavalues[0],datavalues[1],datavalues[2],datavalues[3],datavalues[4],np.nan,datavalues[6])  # write datapoint into datafile
...
a.qdac_gateset(3,0)
print(qdac1.getDCVoltage(3))
a.qdac_1gate(1,'gate_left',start1,end1,xstep1,rev,threshold,compliance)
