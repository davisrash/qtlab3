...
class S1():
    ...
    def take_data(self,x):
                ...
                if DMM==False :
                    ...
                    L1_Y = keithley2.readnext()/10*LIsens   
...
filename = 'VA485_Hbar_noise_test'
number_gates = 1
...
#a.Magnet_sweep(3,1,V_Gate,delay,Bramp)
#a.Magnet_sweep(0.855,1,V_Gate,delay,Bramp)
#magnet.get_fieldZ(0.86)
a.record(V_Gate,tstop,delay)


#qdac1.rampDCVoltage(1,0)
