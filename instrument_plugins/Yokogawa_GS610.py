...
class Yokogawa_GS610(Instrument):
    ...
    def __init__(self, name: str, address: str, reset: bool = False):
        ...
        self.add_parameter('source_delay', type=float,
                           flags=Instrument.FLAG_GETSET,
                           #minval=1e-6, maxval=3600,
                           #format='%.7f',
                           doc="Sets the source delay or queries the current "
                               "setting.",
                           option_list=('min', 'max'))
        self.add_parameter('source_pulse_width_minimum', type=float,
                           flags=Instrument.FLAG_GET, units='s')
        self.add_parameter('source_pulse_width_maximum', type=float,
                           flags=Instrument.FLAG_GET, units='s')
        self.add_parameter('source_pulse_width', type=float,
                           flags=Instrument.FLAG_GETSET,
                           minval=1e-4, maxval=3600, units='s')
        self.add_parameter('source_list_select', type=str,
                           flags=Instrument.FLAG_GETSET)
        self.add_parameter('source_list_catalog', type=list,
                           flags=Instrument.FLAG_GET)
        self.add_parameter('source_voltage_range_minimum', type=float,
                           flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_voltage_range_maximum', type=float,
                           flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_voltage_range', type=float,
                           flags=Instrument.FLAG_GETSET,
                           #minval=, maxval=, units='V'
                           )
        self.add_parameter('source_voltage_level_minimum', type=float,
                           flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_voltage_level_maximum', type=float,
                           flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_voltage_level', type=float,
                           flags=Instrument.FLAG_GETSET,
                           #minval=, maxval=,
                           )
        self.add_parameter('source_voltage_pulse_base_minimum', type=float,
                           flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_voltage_pulse_base_maximum', type=float,
                           flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_voltage_pulse_base', type=float,
                            flags=Instrument.FLAG_GETSET,
                            #minval=, maxval=, units='V'
                            )
        self.add_parameter('source_voltage_protection_upper_limit_minimum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_voltage_protection_upper_limit_maximum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_voltage_protection_upper_limit', type=float, flags=Instrument.FLAG_GETSET, minval=(float)(
            self.do_get_source_voltage_protection_upper_limit_minimum()), maxval=(float)(self.do_get_source_voltage_protection_upper_limit_maximum()), units='V')
        self.add_parameter('source_voltage_protection_lower_limit_minimum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_voltage_protection_lower_limit_maximum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_voltage_protection_lower_limit', type=float, flags=Instrument.FLAG_GETSET, minval=(float)(
            self.do_get_source_voltage_protection_lower_limit_minimum()), maxval=(float)(self.do_get_source_voltage_protection_lower_limit_maximum()), units='V')
        self.add_parameter('source_voltage_sweep_start_minimum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_voltage_sweep_start_maximum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_voltage_sweep_start', type=float, flags=Instrument.FLAG_GETSET, minval=(float)(
            self.do_get_source_voltage_sweep_start_minimum()), maxval=(float)(self.do_get_source_voltage_sweep_start_maximum()), units='V')
        self.add_parameter('source_voltage_sweep_stop_minimum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_voltage_sweep_stop_maximum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_voltage_sweep_stop', type=float, flags=Instrument.FLAG_GETSET, minval=(float)(
            self.do_get_source_voltage_sweep_stop_minimum()), maxval=(float)(self.do_get_source_voltage_sweep_stop_maximum()), units='V')
        self.add_parameter('source_voltage_sweep_step_minimum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_voltage_sweep_step_maximum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_voltage_sweep_step', type=float, flags=Instrument.FLAG_GETSET, minval=(float)(
            self.do_get_source_voltage_sweep_step_minimum()), maxval=(float)(self.do_get_source_voltage_sweep_step_maximum()), units='V')
        self.add_parameter('source_voltage_sweep_points_minimum',
                           type=int, flags=Instrument.FLAG_GET)
        self.add_parameter('source_voltage_sweep_points_maximum',
                           type=int, flags=Instrument.FLAG_GET)
        self.add_parameter('source_voltage_sweep_points', type=int, flags=Instrument.FLAG_GET, minval=(int)(
            self.do_get_source_voltage_sweep_points_minimum()), maxval=(int)(self.do_get_source_voltage_sweep_points_maximum()))
        self.add_parameter('source_voltage_zero_impedance', type=int,
                           flags=Instrument.FLAG_GETSET, minval=0, maxval=1, format_map={0: 'LOW', 1: 'HIGH'})
        self.add_parameter('source_voltage_zero_offset', type=float, flags=Instrument.FLAG_GETSET, minval=(float)(
            self.do_get_source_voltage_range_minimum()), maxval=(float)(self.do_get_source_voltage_range_maximum()), units='V')
        self.add_parameter('source_current_range_minimum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_current_range_maximum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_current_range', type=float, flags=Instrument.FLAG_GETSET, minval=(float)(
            self.do_get_source_current_range_minimum()), maxval=(float)(self.do_get_source_current_range_maximum()), units='V')
        self.add_parameter('source_current_level_minimum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_current_level_maximum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_current_level', type=float, flags=Instrument.FLAG_GETSET, minval=(float)(
            self.do_get_source_current_level_minimum()), maxval=(float)(self.do_get_source_current_level_maximum()), units='V')
        self.add_parameter('source_current_pulse_base_minimum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_current_pulse_base_maximum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_current_pulse_base', type=float, flags=Instrument.FLAG_GETSET, minval=(float)(
            self.do_get_source_current_pulse_base_minimum()), maxval=(float)(self.do_get_source_current_pulse_base_maximum()), units='V')
        self.add_parameter('source_current_protection_upper_limit_minimum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_current_protection_upper_limit_maximum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_current_protection_upper_limit', type=float, flags=Instrument.FLAG_GETSET, minval=(float)(
            self.do_get_source_current_protection_upper_limit_minimum()), maxval=(float)(self.do_get_source_current_protection_upper_limit_maximum()), units='V')
        self.add_parameter('source_current_protection_lower_limit_minimum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_current_protection_lower_limit_maximum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_current_protection_lower_limit', type=float, flags=Instrument.FLAG_GETSET, minval=(float)(
            self.do_get_source_current_protection_lower_limit_minimum()), maxval=(float)(self.do_get_source_current_protection_lower_limit_maximum()), units='V')
        self.add_parameter('source_current_sweep_start_minimum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_current_sweep_start_maximum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_current_sweep_start', type=float, flags=Instrument.FLAG_GETSET, minval=(float)(
            self.do_get_source_current_sweep_start_minimum()), maxval=(float)(self.do_get_source_current_sweep_start_maximum()), units='V')
        self.add_parameter('source_current_sweep_stop_minimum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_current_sweep_stop_maximum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_current_sweep_stop', type=float, flags=Instrument.FLAG_GETSET, minval=(float)(
            self.do_get_source_current_sweep_stop_minimum()), maxval=(float)(self.do_get_source_current_sweep_stop_maximum()), units='V')
        self.add_parameter('source_current_sweep_step_minimum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_current_sweep_step_maximum',
                           type=float, flags=Instrument.FLAG_GET, units='V')
        self.add_parameter('source_current_sweep_step', type=float, flags=Instrument.FLAG_GETSET, minval=(float)(
            self.do_get_source_current_sweep_step_minimum()), maxval=(float)(self.do_get_source_current_sweep_step_maximum()), units='V')
        self.add_parameter('source_current_sweep_points_minimum',
                           type=int, flags=Instrument.FLAG_GET)
        self.add_parameter('source_current_sweep_points_maximum',
                           type=int, flags=Instrument.FLAG_GET)
        self.add_parameter('source_current_sweep_points', type=int, flags=Instrument.FLAG_GET, minval=(int)(
            self.do_get_source_current_sweep_points_minimum()), maxval=(int)(self.do_get_source_current_sweep_points_maximum()))
        self.add_parameter('source_current_zero_impedance', type=int,
                           flags=Instrument.FLAG_GETSET, minval=0, maxval=1, format_map={0: 'LOW', 1: 'HIGH'})
        self.add_parameter('source_current_zero_offset', type=float, flags=Instrument.FLAG_GETSET, minval=(float)(
            self.do_get_source_current_range_minimum()), maxval=(float)(self.do_get_source_current_range_maximum()), units='V')
        self.add_parameter('source_range_auto', type=int,
                           flags=Instrument.FLAG_GETSET, minval=0, maxval=1)
        self.add_parameter('source_protection', type=int,
                           flags=Instrument.FLAG_GETSET, minval=0, maxval=1)
        self.add_parameter('source_protection_linkage', type=int,
                           flags=Instrument.FLAG_GETSET, minval=0, maxval=1)
        self.add_parameter('source_sweep_spacing', type=int, flags=Instrument.FLAG_GETSET,
                           minval=0, maxval=1, format_map={0: 'LIN', 1: 'LOG'})

        # sweep parameters
        self.add_parameter('sweep_count_minimum', type=int,
                           flags=Instrument.FLAG_GET)
        self.add_parameter('sweep_count_maximum', type=int,
                           flags=Instrument.FLAG_GET)
        self.add_parameter('sweep_count', type=int, flags=Instrument.FLAG_GETSET, minval=(int)(
            self.do_get_sweep_count_minimum()), maxval=(int)(self.do_get_sweep_count_maximum()))
        self.add_parameter('sweep_last', type=int, flags=Instrument.FLAG_GETSET,
                           minval=0, maxval=1, format_map={0: 'KEEP', 1: 'RET'})

        # measurement parameters
        self.add_parameter('sense', type=int,
                           flags=Instrument.FLAG_GETSET, minval=0, maxval=1)
        self.add_parameter('sense_function', type=int, flags=Instrument.FLAG_GETSET,
                           minval=0, maxval=2, format_map={0: 'VOLT', 1: 'CURR', 2: 'RES'})
        self.add_parameter('sense_range_auto', type=int,
                           flags=Instrument.FLAG_GETSET, minval=0, maxval=1)
        self.add_parameter('sense_integration_time_minimum',
                           type=float, flags=Instrument.FLAG_GET, units='s')
        self.add_parameter('sense_integration_time_maximum',
                           type=float, flags=Instrument.FLAG_GET, units='s')
        self.add_parameter('sense_integration_time', type=float, flags=Instrument.FLAG_GETSET, minval=(float)(
            self.do_get_sense_integration_time_minimum()), maxval=(float)(self.do_get_sense_integration_time_maximum()), units='s')
        self.add_parameter('sense_delay_minimum', type=float,
                           flags=Instrument.FLAG_GET, units='s')
        self.add_parameter('sense_delay_maximum', type=float,
                           flags=Instrument.FLAG_GET, units='s')
        self.add_parameter('sense_delay', type=float, flags=Instrument.FLAG_GETSET, minval=(float)(
            self.do_get_sense_delay_minimum()), maxval=(float)(self.do_get_sense_delay_maximum()), units='s')
        self.add_parameter('sense_auto_zero', type=int,
                           flags=Instrument.FLAG_GETSET, minval=0, maxval=1)
        self.add_parameter('sense_average', type=int,
                           flags=Instrument.FLAG_GETSET, minval=0, maxval=1)
        self.add_parameter('sense_average_mode', type=int, flags=Instrument.FLAG_GETSET,
                           minval=0, maxval=1, format_map={0: 'BLOC', 1: 'MOV'})
        self.add_parameter('sense_average_count_minimum',
                           type=int, flags=Instrument.FLAG_GET)
        self.add_parameter('sense_average_count_maximum',
                           type=int, flags=Instrument.FLAG_GET)
        self.add_parameter('sense_average_count', type=int, flags=Instrument.FLAG_GETSET, minval=(int)(
            self.do_get_sense_average_count_minimum()), maxval=(int)(self.do_get_sense_average_count_maximum()))
        ...
        # trigger parameters
        self.add_parameter('trigger_source', type=int, flags=Instrument.FLAG_GETSET,
                           minval=0, maxval=2, format_map={0: 'TIM', 1: 'EXT', 2: 'IMM'})
        self.add_parameter('trigger_timer_minimum', type=float,
                           flags=Instrument.FLAG_GET, units='s')
        self.add_parameter('trigger_timer_maximum', type=float,
                           flags=Instrument.FLAG_GET, units='s')
        self.add_parameter('trigger_timer', type=float, flags=Instrument.FLAG_GETSET, minval=(float)(
            self.do_get_trigger_timer_minimum()), maxval=(float)(self.do_get_trigger_timer_maximum()), units='s')

        # computation parameters
        self.add_parameter('calculate_null', type=int,
                           flags=Instrument.FLAG_GETSET, minval=0, maxval=1)
        self.add_parameter('calculate_null_offset', type=float,
                           flags=Instrument.FLAG_GETSET, minval=-9.99999e24, maxval=9.99999e24)
        self.add_parameter('calculate_math', type=int,
                           flags=Instrument.FLAG_GETSET, minval=0, maxval=1)
        self.add_parameter('calculate_math_select', type=str,
                           flags=Instrument.FLAG_GETSET)
        self.add_parameter('calculate_math_catalog',
                           type=list, flags=Instrument.FLAG_GET)
        ...
        self.add_parameter('calculate_limit', type=int,
                           flags=Instrument.FLAG_GETSET, minval=0, maxval=1)
        self.add_parameter('calculate_limit_upper_minimum',
                           type=float, flags=Instrument.FLAG_GET)
        self.add_parameter('calculate_limit_upper_maximum',
                           type=float, flags=Instrument.FLAG_GET)
        self.add_parameter('calculate_limit_upper', type=float, flags=Instrument.FLAG_GETSET, minval=(float)(
            self.do_get_calculate_limit_upper_minimum()), maxval=(float)(self.do_get_calculate_limit_upper_maximum()))
        self.add_parameter('calculate_limit_lower_minimum',
                           type=float, flags=Instrument.FLAG_GET)
        self.add_parameter('calculate_limit_lower_maximum',
                           type=float, flags=Instrument.FLAG_GET)
        self.add_parameter('calculate_limit_lower', type=float, flags=Instrument.FLAG_GETSET, minval=(float)(
            self.do_get_calculate_limit_lower_minimum()), maxval=(float)(self.do_get_calculate_limit_lower_maximum()))
        ...
        # common parameters
        self.add_parameter(
            'save', type=int, flags=Instrument.FLAG_SET, minval=1, maxval=4)
        self.add_parameter('recall', type=int,
                           flags=Instrument.FLAG_SET, minval=1, maxval=4)
        self.add_parameter('service_request_enable_register', type=int,
                           flags=Instrument.FLAG_GETSET, minval=0, maxval=255)
    ...
    def do_set_output_state(self, state: str):
        """
    ...
    def do_set_output_program(self, state: str):
        """
    ...
    def do_set_source_function(self, function: str):
        """
    ...
    def do_set_source_shape(self, shape: str):
        """
    ...
    def do_set_source_mode(self, mode: str):
        """
...
#        return self._visainstrument.query(':SOUR:DEL? MAX').replace('\n', '')
    ...
    # bounds: Optional[str]
    def do_get_source_delay(self, bounds: str = None):
        """
        Queries and returns the source delay.

        TODO add [parameters and] returns
        """
        if bounds is not None:
            return self._visainstrument.query(':SOUR:DEL? {}'.format(bounds)).replace('\n', '')
        else:
    ...
    def do_get_source_voltage_zero_impedance(self):
        ...
        """
        map = self.get_parameters(
        )['source_voltage_zero_impedance']['format_map']
    ...
    def do_set_source_voltage_zero_impedance(self, impedance):
        ...
        Output:
            None
        """
        self._visainstrument.write(':SOUR:VOLT:ZERO:IMP %s' % self.get_parameters()[
                                   'output']['format_map'][impedance])
    ...
    def do_get_source_current_zero_impedance(self):
        ...
        """
        map = self.get_parameters(
        )['source_current_zero_impedance']['format_map']
    ...
    def do_set_source_current_zero_impedance(self, impedance):
        ...
        Output:
            None
        """
        self._visainstrument.write(':SOUR:CURR:ZERO:IMP %s' % self.get_parameters()[
                                   'output']['format_map'][impedance])
    ...
    def do_set_source_sweep_spacing(self, spacing):
        ...
        Output:
            None
        """
        self._visainstrument.write(':SOUR:VOLT:SWE:SPAC %s' % self.get_parameters()[
    ...
    def do_set_sense_average_mode(self, mode):
        ...
        Output:
            None
        """
        self._visainstrument.write(':SENS:AVER:MODE %s' % self.get_parameters()[
                                   'sense_average_mode']['format_map'][mode])
